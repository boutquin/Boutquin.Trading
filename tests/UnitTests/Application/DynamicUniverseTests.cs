...
public sealed class DynamicUniverseTests
{
    ...
    private static readonly Symbol s_unknown = new("UNKNOWN");

    private static IReadOnlyDictionary<Symbol, DateOnly> CreateEntryDates() =>
    ...
    public void SelectAsOf_BeforeAnyEntryDate_ReturnsEmpty()
    {
        ...
        var candidates = new List<Symbol> { s_vti, s_bnd, s_gld };
    ...
    {
        var universe = new DynamicUniverse(CreateEntryDates());
        var candidates = new List<Symbol> { s_bnd };
    ...
    {
        var universe = new DynamicUniverse(CreateEntryDates());
        var candidates = new List<Symbol> { s_vti, s_unknown };
    ...
    {
        var act = () => new DynamicUniverse(new Dictionary<Symbol, DateOnly>());
    ...
    public void SelectAsOf_PreservesOrderOfCandidates()
    {
        ...
        var candidates = new List<Symbol> { s_gld, s_bnd, s_vti };
    ...
    public void CompositeTimedSelector_Select_DelegatesToMaxDate()
    {
        ...
        var candidates = new List<Symbol> { s_vti, s_bnd };
    ...
    public void SupersessionFilter_ReplacementPresent_ExcludesPredecessor()
    {
        ...
        var result = filter.Select(new List<Symbol> { s_schd, s_jepi });
    ...
    public void SupersessionFilter_ReplacementAbsent_KeepsPredecessor()
    {
        ...
        var result = filter.Select(new List<Symbol> { s_schd });
    ...
    public void SupersessionFilter_NoSupersessionRule_KeepsAll()
    {
        ...
        var filter = new SupersessionFilter(metadata);
        var result = filter.Select(new List<Symbol> { s_vti, s_bnd });
    ...
    public void SupersessionFilter_UnknownAsset_KeepsIt()
    {
        ...
        var result = filter.Select(new List<Symbol> { s_vti, s_unknown });
    ...
    public void SupersessionFilter_WithDynamicUniverse_TimeAwareExclusion()
    {
        ...
        var candidates = new List<Symbol> { s_vti, s_schd, s_jepi };
