...
public sealed class DecimalArrayExtensionsTests
{
    ...
    /// <summary>
    /// Tests the <see cref="DecimalArrayExtensions.CompoundAnnualGrowthRate"/> method with various valid input data 
    ...
    /// <summary>
    /// Tests the <see cref="DecimalArrayExtensions.Alpha"/> method with various valid input data
