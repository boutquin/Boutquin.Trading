...
public sealed class DecimalArrayExtensionsTestData
{
    ...
    {
        new object[] { new[] { 0.01m, 0.02m, -0.01m, 0.03m, -0.02m }, 0.0207364413533277m },
        new object[] { new[] { 0.05m, -0.02m, 0.03m, -0.01m, 0.01m }, 0.0286356421265527m },
        new object[] { new[] { 0.1m, -0.05m, 0.2m, -0.1m, 0.15m }, 0.129421791055448m }
    };
    ...
    {
        new object[] { new[] { 0.01m, 0.02m, -0.01m, 0.03m, -0.02m }, 0.3291808013842836299501026838m },
        new object[] { new[] { 0.05m, -0.02m, 0.03m, -0.01m, 0.01m }, 0.4545767261970181149375773712m },
        new object[] { new[] { 0.1m, -0.05m, 0.2m, -0.1m, 0.15m }, 2.0545072401916686621879541000m }
    };
    ...
    {
        new object[]{ new[] { 0.01m, -0.02m, 0.03m, 0.04m, -0.05m }, 252, 0.43991742034859m },
        new object[]{ new[] { 0.02m, -0.03m, 0.01m, -0.05m, 0.04m, 0.02m, -0.01m, 0.03m }, 252, 1.30658087675057m },
        new object[]{ new[] { 0.005m, 0.015m, -0.01m, 0.02m, -0.015m, 0.01m }, 365, 3.4295408134865m },
        new object[]{ new[] { 0.01m, 0.015m, 0.02m, 0.025m, 0.03m }, 260, 170.132009610452m }
    };
    ...
    {
        new object[] { new[] { 0.01m, 0.02m, -0.01m, 0.03m, -0.02m }, 0m, 0.289345693302247559290018236m },
        new object[] { new[] { 0.01m, 0.02m, -0.01m, 0.03m, -0.02m }, 0.001m, 0.2411214110852062994083485302m },
        new object[] { new[] { 0.05m, -0.02m, 0.03m, -0.01m, 0.01m }, 0m, 0.4190581774617470139184156818m }
    };
    ...
    {
        new object[] { new[] { 0.01m, 0.02m, -0.01m, 0.03m, -0.02m }, 0m, 4.5932204844318738515833167967m },
        new object[] { new[] { 0.01m, 0.02m, -0.01m, 0.03m, -0.02m }, 0.001m, 3.8276837370265615429860973298m },
        new object[] { new[] { 0.05m, -0.02m, 0.03m, -0.01m, 0.01m }, 0m, 6.6523423345905119303163281909m }
    };
    ...
    public static IEnumerable<object[]> SortinoRatioData =>
        new List<object[]>
        {
            new object[] { new[] { 0.01m, -0.02m, 0.03m, -0.01m, 0.02m }, 0m, 0.6M },
            new object[] { new[] { 0.01m, -0.02m, 0.03m, -0.01m, 0.02m}, 0.001m, 0.4716141736903387242187952006m }
        };
    ...
    public static IEnumerable<object[]> AnnualizedSortinoRatioData =>
        new List<object[]>
        {
            new object[] { new[] { 0.01m, -0.02m, 0.03m, -0.01m, 0.02m }, 0m, 252, 9.52470471983250m },
            new object[] { new[] { 0.01m, -0.02m, 0.03m, -0.01m, 0.02m }, 0.001m, 252, 7.4866429101471228181206753726m }
        };

    /// <summary>
    /// Gets a collection of test cases containing varied decimal arrays and their corresponding CAGR values.
    /// </summary>
    public static IEnumerable<object[]> CompoundAnnualGrowthRateData => new List<object[]>
    {
        new object[] { new[] { 0.01m, 0.02m, -0.01m, 0.03m, -0.02m }, 332.56367192912200m },
        new object[] { new[] { 0.05m, -0.02m, 0.03m, -0.01m, 0.01m }, 1764.4127297619500m }
    };
    ...
    public static IEnumerable<object[]> DownsideDeviationData =>
        new List<object[]>
        {
            new object[] { new[] { 0.01m, -0.02m, 0.03m, -0.01m, 0.02m }, 0, 0.01m },
            new object[] { new[] { 0.01m, -0.02m, 0.03m, -0.01m, 0.02m }, 0.001m, 0.0106018866245589m }
        };

    /// <summary>
    /// Gets a collection of test cases containing varied equity curve arrays and their corresponding daily returns arrays.
    /// </summary>
    public static IEnumerable<object[]> DailyReturnsData => new List<object[]>
    {
        new object[]
        {
    ...
    /// </summary>
    public static IEnumerable<object[]> BetaData => new List<object[]>
    {
        new object[]
        {
    ...
    /// </summary>
    public static IEnumerable<object[]> AlphaData => new List<object[]>
    {
        new object[]
        {
            new[] { 0.01m, 0.02m, -0.01m, 0.03m, -0.02m }, 
    ...
    /// </summary>
    public static IEnumerable<object[]> InformationRatioData => new List<object[]>
    {
        new object[] 
        { 
            new[] { 0.01m, 0.02m, -0.01m, 0.03m, -0.02m }, 
