...
public static class MarketDataFileNameHelper
{
    ...
    {
        return SanitizeTickerForFileName(ticker) + ".csv";
    }

    public static string GetCsvFileNameForDividendData(string ticker)
    {
        return SanitizeTickerForFileName(ticker) + "_dividends.csv";
    }
