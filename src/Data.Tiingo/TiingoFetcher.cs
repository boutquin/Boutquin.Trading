...
public sealed class TiingoFetcher : IMarketDataFetcher, IDisposable
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TiingoFetcher"/> class.
    /// </summary>
    /// <param name="apiKey">The Tiingo API key.</param>
    /// <param name="httpClient">Optional HTTP client for making requests.</param>
    /// <param name="apiEndpoint">Base URL for the Tiingo API.</param>
