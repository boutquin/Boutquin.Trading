...
public sealed class CompositeMarketDataFetcher : IMarketDataFetcher, IDisposable
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CompositeMarketDataFetcher"/> class.
    /// </summary>
    /// <param name="equityFetcher">The fetcher for equity market data.</param>
    /// <param name="fxFetcher">The fetcher for foreign exchange rate data.</param>
