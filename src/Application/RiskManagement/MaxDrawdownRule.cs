...
public sealed class MaxDrawdownRule : IRiskRule
{
    ...
    /// Intermediate arithmetic on equity curve values can introduce
    /// sub-basis-point rounding that should not trigger a drawdown breach.
    /// </summary>
    ...
    public RiskEvaluation Evaluate(Order order, IPortfolio portfolio)
    {
        ...
        if (currentDrawdown > _maxDrawdownPercent + Tolerance)
        {
