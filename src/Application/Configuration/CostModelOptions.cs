...
public sealed class CostModelOptions
{
    ...
    /// <summary>
    /// The type of transaction cost model (e.g., "FixedPerTrade", "PercentageOfValue", "PerShare").
    /// </summary>
    ...
    /// <summary>
    /// Maximum fraction of bar volume that can be consumed by a single order.
    /// Only used when SlippageType is "VolumeShareSlippage". Default: 0.025 (2.5%).
    /// </summary>
