...
/// <summary>
/// Computes annualized realized volatility as the sample standard deviation of returns
/// over a rolling window, scaled by √(tradingDaysPerYear).
/// </summary>
public sealed class RealizedVolatility : IIndicator
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RealizedVolatility"/> class.
    /// </summary>
    /// <param name="window">The number of trailing returns to use. Must be at least 2.</param>
    /// <param name="tradingDaysPerYear">Annualization factor. Defaults to 252.</param>
