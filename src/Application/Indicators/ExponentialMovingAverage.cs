...
/// <summary>
/// Computes the Exponential Moving Average (EMA) using smoothing factor α = 2/(period+1),
/// seeded with the SMA of the first <c>period</c> values.
/// </summary>
public sealed class ExponentialMovingAverage : IIndicator
{
    ...
    /// </summary>
    /// <param name="period">The lookback period that determines the smoothing factor. Must be positive.</param>
