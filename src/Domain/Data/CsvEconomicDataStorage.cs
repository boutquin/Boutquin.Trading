...
public sealed class CsvEconomicDataStorage
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CsvEconomicDataStorage"/> class.
    /// </summary>
    /// <param name="directory">Path to the directory for storing FRED CSV files.</param>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            {
                var line = FormattableString.Invariant($"{kvp.Key:yyyy-MM-dd},{kvp.Value}");
